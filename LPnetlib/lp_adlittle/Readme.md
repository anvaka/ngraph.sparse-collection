# LPnetlib/lp_adlittle
 ...
 http://www.cise.ufl.edu/research/sparse/matrices/LPnetlib/lp_adlittle

 [Netlib LP problem adlittle: minimize c'*x, where Ax=b, lo<=x<=hi]
...
![LPnetlib/lp_adlittle](http://www2.research.att.com/~yifanhu/GALLERY/GRAPHS/GIF_SMALL/LPnetlib@lp_adlittle.gif)